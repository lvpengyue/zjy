                        ...
                        <Row type="flex" justify="end" align="middle" class="user-dropdown-innercon">
                            <Dropdown transfer trigger="click" @on-click="handleClickUserDropdown">
                                ...
                                <DropdownMenu slot="list">
                                    ...
                                    <DropdownItem name="editPass" divided>修改密码</DropdownItem>
        ...
        <Modal v-model="editPass"
            ...
            <div>
                <Form :model="formValidate"
                      ...
                      :rules="ruleValidate"
                      :label-width="180">
                    <FormItem label="请设置新密码：" prop="newPassword">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            // avatorPath () {
            //     return JSON.parse(Cookies.get('user')).pic;
            // },
            cachePage () {
            ...
            saveEdit (name) {
                this.$refs[name].validate(async (valid) => {
                    if (valid) {
                        ...
                        await this.mainGetEditData({
                            newPwd: this.formValidate.newPassword,
                        })

                        if (this.mainEditData && this.mainEditData.code == 0) {
                            this.$Notice.warning({
                                title: this.mainEditData.info
                            });
                            ...
                            this.$Modal.success({
                                title: '修改密码成功',
                                content: '修改密码成功后需要重新登陆',
                                onOk: async () => {
                                    await this.loginGetLogout();
