                    ...
                    <Col :md="12" :lg="24" :style="{marginBottom: '10px'}">
                        <Card>
                            <Row type="flex" class="user-infor">
                                <Col span="8">
                                    <Row class-name="made-child-con-middle" type="flex" align="middle">
                                        <img class="avator-img" src="./assets/yjyt.png" />
                                    </Row>
                                </Col>
                            ...
                            <!-- <Row class="margin-top-8">
                                ...
                                <Col span="16" class="padding-left-8">{{userData.lastLogTime}}</Col>
                            </Row>
                            <Row class="margin-top-8">
                                <Col span="8"><p class="notwrap">上次登录IP:</p></Col>
                                <Col span="16" class="padding-left-8">{{userData.ip}}</Col>
                            </Row> -->
                        </Card>
                    </Col>
                    <!-- <Col :md="12" :lg="24" :style="{marginBottom: '10px'}">
...
export default {
    ...
    async mounted () {
        ...
        // this.userRole = JSON.parse(Cookies.get('userRole'));
